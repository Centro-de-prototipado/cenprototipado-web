  ...
  return (
    <section className="relative w-full border-b" id="quienes-somos">
      ...
      <div className="border-b px-12 py-16 md:px-16 md:py-20">
        <Reveal as="div" className="mx-auto flex max-w-5xl flex-col gap-6">
      ...
      <div className="grid border-b md:grid-cols-2">
        <Reveal
          as="article"
          index={0}
          className="border-b bg-card/30 p-6 md:border-r md:border-b-0 md:p-10"
        >
        ...
        <Reveal as="article" index={1} className="bg-card/30 p-6 md:p-10">
          <p className="text-xs tracking-[0.24em] text-muted-foreground uppercase">
            Visión
          </p>
          <p className="mt-3 text-sm text-muted-foreground md:text-base">
